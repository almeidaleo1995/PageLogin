...
let virtual-env = "C:\WorkSpace\Estudo\Python6\Create_LoginPage\flaskLoginPageEnv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\WorkSpace\Estudo\Python6\Create_LoginPage\flaskLoginPageEnv\Scripts\deactivate.nu"
